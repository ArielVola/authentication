export const activationAccountEmail = (verifyCode: Number) => {
    return `
        <h1 style="color:#4B556B;">Te damos la bienvenida a <span style="color:#FC6767;">"x" App</span></h1>
...
export const restorePasswordEmail = (restorePasswordCode: Number) => {
    return `
        <h1 style="color:#4B556B;">Código de recuperación en tu cuenta de <span style="color:#FC6767;">"x" App</span></h1>
